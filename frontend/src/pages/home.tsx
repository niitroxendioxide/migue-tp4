    ...
    <Layout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold u-text-title mb-4">
            Discover Amazing Events
          </h1>
          <p className="text-xl u-text-muted max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="p-6 rounded-lg shadow-sm text-center border border-border bg-surface">
            <div className="text-3xl font-extrabold text--primary mb-2">{events.length}</div>
            <div className="u-text-soft font-medium">Total Events</div>
          </div>
          <div className="p-6 rounded-lg shadow-sm text-center border border-border bg-surface">
            <div className="text-3xl font-extrabold text-success mb-2">
              {events.filter(e => !e.is_paid).length}
            </div>
            <div className="u-text-soft font-medium">Free Events</div>
          </div>
          <div className="p-6 rounded-lg shadow-sm text-center border border-border bg-surface">
            <div className="text-3xl font-extrabold text-primary mb-2">
              {events.filter(e => new Date(e.date) > new Date()).length}
            </div>
            <div className="u-text-soft font-medium">Upcoming Events</div>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            <svg 
              className="mx-auto h-24 w-24 u-text-subtle mb-4" 
              fill="none" 
              stroke="currentColor" 
              viewBox="0 0 24 24"
            >
            ...
            <h3 className="text-xl font-medium u-text-title mb-2">No events found</h3>
